...
('admin@gmail.com', 'L''administrateur', 'UserAdmin', '$2y$13$vDdTvu9ixbwkU3HlEY/2DOtQw/k5UBy0.GAJOTP/AYa9ip8bXYybS', '["ROLE_ADMIN"]', 1),
('vétérinaire@gmail.com', 'Le vétérinaire', 'UserVétérinaire', '$2y$13$vDdTvu9ixbwkU3HlEY/2DOtQw/k5UBy0.GAJOTP/AYa9ip8bXYybS', '["ROLE_VETERINAIRE"]', 1),
('employé@gmail.com', 'L''employé', 'UserEmployé', '$2y$13$KkISQjBj.0hdQaXABASw3O3QKkpD0kLQflLWeyHe6k6Ext.Ew6WRC', '["ROLE_EMPLOYE"]', 1);
...
(1, 2, 'Habitat en excellente condition, adapté aux espèces qu''il accueille.', CURDATE()),
(2, 2, 'La jungle présente une diversité biologique remarquable, bien entretenue.', CURDATE()),
(3, 2, 'Le marais nécessite plus d''attention pour contrôler les moustiques.', CURDATE());
...
(1, 3, CURDATE(), 'Viande', 5.0),
(2, 3, CURDATE(), 'Fruits', 1.5),
(3, 3, CURDATE(), 'Feuilles', 10.0);
