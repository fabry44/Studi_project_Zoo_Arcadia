...
class AvisHabitatsVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le AvisHabitatsCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le AvisHabitatsCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== AvisHabitatsCrudController::class) {
            return true;
        }
    ...
    /**
     * Filte l'accès aux action de modification, suppression et création d'un animal uniquement pour le vétérinaire.
     *
