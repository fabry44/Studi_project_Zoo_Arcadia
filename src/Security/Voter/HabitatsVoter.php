...
class HabitatsVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le HabitatsCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le HabitatsCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== HabitatsCrudController::class) {
            return true;
        }
    ...
    /**
     * Filte l'accès aux action de modification, suppression et création d'un habitat uniquement pour l'administrateurs.
     *
