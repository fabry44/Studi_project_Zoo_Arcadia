...
use App\Controller\Admin\Crud\ImgServicesCrudController;
use EasyCorp\Bundle\EasyAdminBundle\Provider\AdminContextProvider;
use Symfony\Bundle\SecurityBundle\Security;

class ImgServicesVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le ImgServicesCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le ImgServicesCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== ImgServicesCrudController::class) {
            return true;
        }
