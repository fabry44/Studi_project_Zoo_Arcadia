...
class RapportsVeterinaireVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le RapportsVeterinairesCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le RapportsVeterinairesCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== RapportsVeterinairesCrudController::class) {
            return true;
        }
    ...
    /**
     * Filte l'accès aux action de modification, suppression et création d'un rapport vétérinaire uniquement pour le vétérinaire.
     *
    ...
    private function canExecuteAction($context): bool
  {
      ...
      // Les actions 'new', 'edit' et 'delete' sont réservées aux vétérinaires
