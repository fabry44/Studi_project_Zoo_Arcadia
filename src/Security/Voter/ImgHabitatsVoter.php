...
use App\Controller\Admin\Crud\ImgHabitatsCrudController;
use EasyCorp\Bundle\EasyAdminBundle\Provider\AdminContextProvider;
use Symfony\Bundle\SecurityBundle\Security;

class ImgHabitatsVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le ImgHabitatsCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le ImgHabitatsCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== ImgHabitatsCrudController::class) {
            return true;
        }
