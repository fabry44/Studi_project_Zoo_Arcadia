...
class AlimentationsVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le AlimentationsCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le AlimentationsCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== AlimentationsCrudController::class) {
            return true;
        }
    ...
    /**
     * Filte l'accès aux action de modification, suppression et création pour l'alimentation d'un animal uniquement pour l'employé.
     *
