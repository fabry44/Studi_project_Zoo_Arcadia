...
class AnimauxVoter extends Voter
{
    private $security;
    ...
    /**
     * Cette méthode vérifie si l'utilisateur a le droit d'effectuer une action dans le AnimauxCrudController.
     *
     ...
     * @return bool Retourne true si l'utilisateur a le droit à l'action dans le AnimauxCrudController, sinon false.
     */
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if ($crudController !== AnimauxCrudController::class) {
            return true;
        }
    ...
    /**
     * Filte l'accès aux action de modification, suppression et création d'un animal uniquement pour l'administrateurs.
     *
